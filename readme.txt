...
BP Dokumente adds collaborative work spaces to your BuddyPress community. Part wiki, part document editing, part shared dropbox, think of these Docs as a BuddyPress version of the Docs service offered by the Big G *ifyouknowwhatimean*
...
This plugin is in active development. For feature requests and bug reports, visit http://github.com/boonebgorges/bp-docs. If you have translated the plugin and would like to provide your translation for distribution with BP Dokumente, please contact the plugin author.
...
* Fixed bug that caused 'View Alle Dokumente' link on search results to paginate incorrectly.
...
*    If you use a custom translation, it must be renamed and moved to this location: wp-content/languages/plugins/bp-docs-LOCALE.mo. E.g., wp-content/languages/plugins/bp-docs-es_ES.mo
*    If you use custom template parts, all text domain identifiers must be updated to 'bp-docs'.
...
* Fixed bug that caused "View Alle Dokumente" link to be broken when plugins add filters to Doc directories.
...
* Show deleted Docs on Von mir begonnen tab, so they can be easily restored
...
= 1.5 =
* New standalone Settings panel, under Dashboard > BP Dokumente
...
= 1.2 =
* Major plugin rewrite. See http://dev.commons.gc.cuny.edu/2012/11/15/bp-docs-1-2/ for more details.
