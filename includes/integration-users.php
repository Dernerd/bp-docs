	...
	if ( bp_is_user() ) {
		$user_crumbs = array(
			sprintf(
				...
				sprintf( _x( '%s&#8217;s Dokumente', 'user Docs directory breadcrumb', 'bp-docs' ), esc_html( bp_get_displayed_user_fullname() ) )
			),
		);
