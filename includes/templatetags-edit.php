...
function bp_docs_edit_parent_dropdown() {
	...
	$pages = wp_dropdown_pages( array(
		...
		'selected'         => $parent,
		'name'             => 'parent_id',
		'show_option_none' => __( '(keine Eltern)', 'bp-docs' ),
...
/**
 * Adds BP Dokumente-specific TinyMCE plugins
 *
 * Includes:
 *   - table
 *   - tabindent
...
/**
 * Adds BP Dokumente-specific TinyMCE plugin buttons to row 1 of the editor
 *
...
/**
 * Adds BP Dokumente-specific TinyMCE plugin buttons to row 3 of the editor
 *
 * Includes:
 *   - tablecontrols
 *
