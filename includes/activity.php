...
function bp_docs_post_comment_activity( $comment_id ) {
	...
	$action = sprintf( __( '%1$s hat das Dokument %2$s kommentiert', 'bp-docs' ), $user_link, $comment_link );
...
function bp_docs_post_activity( $query ) {
	...
	if ( $query->is_new_doc ) {
		$action = sprintf( __( '%1$s hat das Dokument %2$s erstellt', 'bp-docs' ), $user_link, $doc_link );
	} else {
		$action = sprintf( __( '%1$s hat das Dokument %2$s bearbeitet', 'bp-docs' ), $user_link, $doc_link );
	}
...
function bp_docs_register_activity_actions() {
	bp_activity_set_action(
		'bp_docs',
		'bp_doc_created',
		__( 'Erstellt ein Dokument', 'bp-docs' ),
	...
	bp_activity_set_action(
		'bp_docs',
		'bp_doc_edited',
		__( 'Dokument bearbeitet', 'bp-docs' ),
	...
	bp_activity_set_action(
		'bp_docs',
		'bp_doc_comment',
		__( 'Kommentar zu einem Doc', 'bp-docs' ),
...
function bp_docs_format_activity_action_bp_doc_comment( $action, $activity ) {
	...
	$action = sprintf( __( '%1$s hat das Dokument %2$s kommentiert', 'bp-docs' ), $user_link, $doc_link );
...
function bp_docs_activity_filter_options() {
	...
	<option value="bp_doc_created"><?php _e( 'Neue Dokumente', 'bp-docs' ); ?></option>
	<option value="bp_doc_edited"><?php _e( 'Dokument bearbeitet', 'bp-docs' ); ?></option>
	<option value="bp_doc_comment"><?php _e( 'Dokumente Kommentare', 'bp-docs' ); ?></option>
