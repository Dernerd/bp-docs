 ...
 * Docs, you may put a file called plugin-bp-docs.php into the root of
 * your theme.
 *
 * @since 1.2
 *
...
class BP_Docs_Theme_Compat {
	...
	public function is_docs() {
		...
		/**
		 * Fires after the BP Dokumente theme compatibility layer has initialized.
		 *
		 * @since 1.9.4
		 *
	...
	function query_templates( $templates ) {
		$templates = array_merge( array( 'plugin-bp-docs.php' ), $templates );
		return $templates;
	}
	...
	public function create_dummy_post() {
		bp_theme_compat_reset_post( array(
			'ID'             => 0,
			'post_title'     => __( 'Erstelle ein Dokument', 'bp-docs' ),
