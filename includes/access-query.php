 ...
 * filtered appropriately, whether they originate with BP Dokumente or not
...
// other plugins using 'pre_get_posts'. See https://github.com/boonebgorges/bp-docs/issues/425
add_action( 'pre_get_posts', 'bp_docs_general_access_protection', 28 );
